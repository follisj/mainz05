...
mg.plot <- ggplot()+
  ...
  #geom_richtext(aes(x=8.5,y=50,label=best.season))+
  ...
  #geom_vline(xintercept = c(17,19),lty=2,col="gray",alpha=.5)+
  #geom_text(data=mainz.games %>% filter(Match==34),aes(x=35,y=Points,label=Points))+
  theme_bw()+
