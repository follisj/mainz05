...
act1 <- wk2wk.pts %>% filter(rank>12,match.day<10) %>%
  ...
  #geom_hline(yintercept=c(16.5,15.4),col="black")+
  ...
  #geom_text(aes(x=11.5,y=12,label="Result"),size=7,fontface="bold",col="black")+
...
act2 <- wk2wk.pts %>% filter(rank>12,match.day %in% 10:21) %>%
  ...
  #geom_text(aes(x=23.5,y=12,label="Result"),size=7,fontface="bold",col="black")+
...
act3 <- wk2wk.pts %>% filter(rank>12,match.day>21) %>%
  ...
  #geom_text(aes(x=36.5,y=12.5,label="Result"),size=7,fontface="bold",col="black")+
...
season.table <- wk2wk.pts %>% filter(match.day==34) %>% 
  ...
  #scale_fill_gradient(low="gray10",high="red")+
  #scale_fill_gradient2(low="gray",mid="black",high="red")+
  #scale_fill_gradientn(colors=c("gray","black","blue","darkred","red"))+
  ...
  #geom_hline(yintercept=c(3.5,10.5,13.5))+
